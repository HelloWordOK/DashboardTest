 ...
 <body>
   			...
   			<form class="form-horizontal" action="" method="post" id="forminfo">
				...
				<div class="col-sm-8">
					...
					<div class="col-sm-offset-5 col-sm-9">
						<button class="btn btn-success" type="button" onclick="responsetime();" autocomplete="off" data-loading-text="Loading..." id="btn_search">Search</button>
    ...
    function responsetime(){
    	...
    	if(validate(param)){
    		showloading();
    		$.ajax({
           		url:path+"sla/daily_website_chart_submit",
           		type:"POST",
