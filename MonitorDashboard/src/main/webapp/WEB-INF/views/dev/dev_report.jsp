	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-10 col-sm-offset-2 main">
				<h2 class="sub-header">Status Report</h2>
				<div class="form">
					...
					<div class="col-sm-1"></div>
						<div class="col-sm-8">
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label class="col-sm-3 control-label">Build History</label>
										<div class="col-sm-7">
											<select class="form-control searchselect" id="history">
												<option value="h1">Gerrit Build History</option>
												<option value="h2">Git Build History</option>
											</select>
										</div>
										<div class="col-sm-1">
											<button class="btn btn-info btn-sm" type="button" onclick="" autocomplete="off" data-loading-text="Loading..." id="btn_import">Submit</button>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-xs-6 col-md-3">
							<img alt="" src="<%=basePath%>static/img/demo_status.png" class="img-rounded">
						</div>
					</div>
					
					<div class="row">
						<div class="col-xs-6 col-md-3">
							<img alt="" src="<%=basePath%>static/img/demo_status_time.png" class="img-rounded">
						</div>
					</div>
