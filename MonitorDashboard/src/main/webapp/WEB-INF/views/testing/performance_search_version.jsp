					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<div class="col-sm-7">
									<select class="form-control searchselect" id="project" onchange="ajaxfunctionType();">
    ...
    <script type="text/javascript">
	    ...
	    function ajaxfunctionType() {
	    	...
	    	$.ajax({
	    		...
	    		type : "POST",
	    		data : "project=" + project + "&environment="+ environment +"&type=" + type,
	    ...
	    function search(){
    		...
    		$.ajax({
           		url:path+"testing/performanceVersion",
           		type:"POST",
           		data:"project="+project+"&environment="+environment+"&version="+version,
           		success:function(data){
