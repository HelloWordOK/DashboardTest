...
public class ExcelReaderUtils {
	...
	public static final Logger logger = Logger.getLogger(ExcelReaderUtils.class);
	/**
	 * Excel 2003
	 */
	...
	public static void main(String[] args) {
		String path = "C:/Users/weijid/Desktop/MonitorDashboard.xlsx";
		List<String> list = null;
		try {
			list = ExcelReaderUtils.exportListFromExcel(new File(path), 0);
