...
public interface AvailDao {
	...
	public List<String> getAvailMonthlyYearList(Map<String, Object> sourceMap) throws MonitorException;

	public List<AvailReport> getAvailMonthlyReport(Map<String, Object> sourceMap) throws MonitorException;
}
